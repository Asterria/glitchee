...
module.exports.run = async (bot, message, args) => { 
  ...
  var embed2 = new Discord.RichEmbed()   
      ...
      .setDescription('sadece sahibim bu komutu  kullanabilir! Yani <@464115526411616257> ')
      .setColor('RANDOM') 
  

  if(message.author.id !== "464115526411616257") return message.channel.sendEmbed(embed2)
     
  //Rowine botun reboot sistemi hadi h.o
  var embed = new Discord.RichEmbed()   
      .setTitle('**Merhaba Sahibim Rowinê,**')
